...
MEGATRON_DUMP="${MEGATRON_DUMP:-artifacts/g1_runtime_megatron_ref_mask_applied_full_group_dump.pt}"
OPENRLHF_DUMP="${OPENRLHF_DUMP:-artifacts/g1_runtime_openrlhf_critic_mask_applied_full_group_dump.pt}"
REPORT_OUT="${REPORT_OUT:-g1_runtime_parity_report_mask_applied_full_group.md}"
